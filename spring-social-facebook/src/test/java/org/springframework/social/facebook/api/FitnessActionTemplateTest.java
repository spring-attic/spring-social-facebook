...
public class FitnessActionTemplateTest extends AbstractFacebookApiTest {
	...
	public void runs() throws Exception {
		mockServer.expect(requestTo(fbUrl("me/fitness.runs")))
			...
			.andExpect(content().string("course=https%3A%2F%2Fsamples.ogp.me%2F226075010839791"))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess("{\"id\": \"123456789080\"}", MediaType.APPLICATION_JSON));

		String actionId = facebook.openGraphOperations().fitnessActions().runs("https://samples.ogp.me/226075010839791");
	...
	public void walks() throws Exception {
		...
		String actionId = facebook.openGraphOperations().fitnessActions().walks("https://samples.ogp.me/226075010839791");
		assertEquals("123456789080", actionId);
	}
	...
	public void bikes() throws Exception {
		...
		String actionId = facebook.openGraphOperations().fitnessActions().bikes("https://samples.ogp.me/226075010839791");
		assertEquals("123456789080", actionId);
	}
