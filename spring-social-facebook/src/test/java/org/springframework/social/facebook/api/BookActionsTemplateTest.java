...
public class BookActionsTemplateTest extends AbstractFacebookApiTest {
	...
	public void readBook() throws Exception {
		mockServer.expect(requestTo("https://graph.facebook.com/me/book.reads"))
	...
	public void quoteBook() throws Exception {
		mockServer.expect(requestTo("https://graph.facebook.com/me/books.quotes"))
			.andExpect(method(POST))
	...
	public void rateBook() throws Exception {
		mockServer.expect(requestTo("https://graph.facebook.com/me/books.rates"))
			.andExpect(method(POST))
	...
	public void wantsToRead() throws Exception {
		mockServer.expect(requestTo("https://graph.facebook.com/me/books.wants_to_read"))
			.andExpect(method(POST))
