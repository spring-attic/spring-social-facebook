...
public class StubConnectionRepository implements ConnectionRepository {
	...
	public void removeConnection(ConnectionKey connectionKey) {
		...
		providerIdConnectionMap.remove(connectionKey.getProviderId()); // remove them all
		for (Connection<?> connection : connections) { // add back any that don't have the same key
